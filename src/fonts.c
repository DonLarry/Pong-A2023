...
{
    fonts->large_font = al_load_ttf_font(FONTS_FOLDER "/font.ttf", 16, ALLEGRO_TTF_MONOCHROME);
    fonts->score_font = al_load_ttf_font(FONTS_FOLDER "/font.ttf", 32, ALLEGRO_TTF_MONOCHROME);
}
